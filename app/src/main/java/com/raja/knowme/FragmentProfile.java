...
import com.raja.knowme.variables.ProfileDetailsObject;
...
public class FragmentProfile extends Fragment {
    ...
    private ArrayList<ProfileDetailsObject> mProfileDetails = new ArrayList<ProfileDetailsObject>(0);
    ...
    private class LoadData extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                mProfileDetails = knowmeData.getProfile();
                loaderResponse = "true";
            } catch (Exception e) {
                e.printStackTrace();
            }
